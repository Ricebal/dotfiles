...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    --Screenshot
    , ((0,xK_Print), spawn "gscreenshot -c")
    , ((shiftMask,xK_Print), spawn "gscreenshot -sc")
...
myLayout = tiled ||| Mirror tiled ||| noBorders Full
  where
     ...
     tiled   = spacingRaw False (Border 5 5 5 5) True (Border 5 5 5 5) True $ Tall nmaster delta ratio
...
myPP = def { ppCurrent = xmobarColor "COLOR2" "" . wrap "<fn=1>\xfb0c</fn> " "<fn=1></fn>"
           , ppTitle = xmobarColor "COLOR2" "" . shorten 30
           , ppVisible = xmobarColor "COLOR2" "" . wrap "" ""
